...
AI was used to explain pathfinding algorithms with step-by-step examples and compare their pros and cons, debug and refactor the code, as well as create some of the test suites.